...
<html lang='en'>
    ...
    <body class="background">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                 ...
                 <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="navbar-nav container-fluid navtext">
                        ...
                        <a class="nav-item nav-link" href="#"><p class="selected"><span class="navaccent hvr-backword">L</span><span class="navrest">OGIN</span> <i class="fa fa-unlock"></i></p></a>
                        <a class="nav-item nav-link" href="registration.html"><p><span class="navaccent" href="registration.html">R</span><span class="navrest">EGISTER</span> <i class="fa fa-pencil-square-o"></i></p></a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <?php
            ...
            $query = "SELECT uuid FROM users WHERE username='$username' AND password='$password'";

                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                 ...
                 <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="navbar-nav container-fluid navtext">
                        ...
                        <a class="nav-item nav-link" href="#"><p class="selected"><span class="navaccent">A</span><span class="navrest">BOUT</span> <i class="fa fa-question"></i></p></a>
        ...
        <div>
            <div class="textarea">
                <div class="containter-fluid">
                    <h1 class="display-3"><span class="navaccent">A</span><span class="navrest">bout</span></h1>
                </div>
            </div>
            ...
            <div class="textarea">
                <div class="containter-fluid">
                    <span class="para lead">This website was developed by Luke Holland and is the product of the Advanced Higher Computing Science Assignment.</span>
                </div>
            </div>
        </div>

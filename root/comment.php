...
<html lang='en'>
    ...
    <body class="background">
        ...
        <?php
            ...
            $commid = generate_uuid();
            $uuid = mysql_real_escape_string($_SESSION['uuid']);
            $factid = mysql_real_escape_string($_POST['factid']);
        
            $query = "INSERT INTO comments (commentid, factid, text, author) VALUES ('$commid', '$factid', '$text', '$uuid')";
